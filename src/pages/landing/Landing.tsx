...
import { Button, Card, Container, Group, Text, Title, Box } from "@mantine/core";
...
const Landing: FC = () => {
  ...
  return (
    ...
    >
      ...
      <Container size="sm" style={{ width: "100%", maxWidth: "35rem" }}>
        <Card
          shadow="xl"
          padding="xl"
          radius="md"
        ...
        >
          ...
          <Text mb="lg" c="dimmed" ta="center" color="dark">
            {user
              ...
              : "Login to explore and manage people records."}
          </Text>
